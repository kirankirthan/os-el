...
pygame.display.set_caption("LRU Demand Paging Simulation")
    ...
    while current_page_index < len(page_sequence):
        ...
        if page not in frames:
            ...
            if None in frames:
                ...
                # Use LRU to determine which page to replace
                lru_page = recent_usage.pop(0)  # Get the least recently used page
                lru_index = frames.index(lru_page)  # Find its index in the frames
                frames[lru_index] = page  # Replace it
